  ...
  <div id="calcApp">
    ...
    <div class="stockHolding" v-for='(data, index) in inputCost' :key='index'>
      <div class="stockHolding-info">
        <span class="stockHolding-info-style">股號</span><span>{{data.stockSymbol}}</span> 
        <span class="stockHolding-info-style">買進價</span><span>{{data.strikePrice}}</span>
        <span class="stockHolding-info-style">張數</span><span>{{data.boardLot}}</span>
      </div>
      <div class="stockHolding-cost">
        <span class="stockHolding-cost-style">總價</span><span>{{data.strikeCost}}</span>
